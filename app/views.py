...
def mobile(request, data=None):
    ...
    if data == None:
        mobiles = Product.objects.filter(category='M')
    elif data == 'Redmi' or data == 'Realme' or data == 'Samsung' or data == 'OPPO' or data == 'OnePlus':
...
def laptop(request, data=None):
    ...
    if data == None:
        laptops = Product.objects.filter(category='L')
    elif data == 'Dell' or data == 'HP' or data == 'Asus' or data == 'Apple':
...
def topwear(request, data=None):
    ...
    if data == None:
        topwears = Product.objects.filter(category='TW')
    elif data == 'DENIM' or data == 'PeterEngland' or data == 'Polo' or data == 'Manyavar':
